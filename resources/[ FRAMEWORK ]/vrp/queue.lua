...
Config.Language = {
	joining = "FrameWork vRPEX Entrando...",
	connecting = "FrameWork vRPEX Conectando...",
	err = "FrameWork vRPEX Não foi possível identificar sua Steam ou Social Club.",
	_err = "FrameWork vRPEX Você foi desconectado por demorar demais na fila.",
	pos = "FrameWork vRPEX Você é o %d/%d da fila, aguarde sua conexão",
	connectingerr = "FrameWork vRPEX Não foi possível adiciona-lo na fila.",
    wlonly = "FrameWork vRPEX Você não está aprovado na whitelist.",
	banned = "FrameWork vRPEX Seu passaporte foi revogado na cidade.",
	steam = "FrameWork vRPEX Você precisa estar com a Steam aberta para conectar."
}
