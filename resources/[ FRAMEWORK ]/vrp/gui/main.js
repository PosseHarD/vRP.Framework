window.addEventListener("load",function(){
	...
	let dynamic_menu = new Menu();
	let wprompt = new WPrompt();
	...
	wpromptNum.onClose = function () {
		...
		$.post("http://vrp/promptNum", JSON.stringify({ act: "close", result: (isNaN(res)  ? false : res )  }));
	};
	...
	window.addEventListener("message",function(evt){
		...
		if(data.act == "cfg"){
			...
			requestmgr.addRequest(data.id,data.text,data.time,data.type,data.caller);
		}
